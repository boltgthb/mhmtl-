        ...
        <div className="bg-stone-50 rounded-xl shadow-md p-6 sm:p-8 md:p-10">
          ...
          <div className="bg-primary-50 border-l-4 border-primary-400 p-4 sm:p-6 rounded-r-lg">
            ...
            <div className="relative w-full overflow-hidden rounded-lg" style={{ paddingBottom: '75%' }}>
              <iframe
                src="<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4310.509156367356!2d39.524183490657585!3d40.014645058977024!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x407aad1c17141a85%3A0x76ce732fc8c1cdaa!2sMahmatl%C4%B1%20Cami!5e1!3m2!1str!2str!4v1763823520546!5m2!1str!2str" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>"
